...
const Card = ({
  ...
  const isOwner = user?._id === ownerId; // elonOwnerId — e’lon egasining user id’si

  return (
    <div className="bg-zinc-300 dark:bg-zinc-700 rounded-lg overflow-hidden hover:shadow-lg shadow-md transition-shadow duration-300 inset-shadow-sm inset-shadow-zinc-900 flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1 justify-between">
        ...
        {/* Tugmalarni doim pastga joylashtirish */}
        <div className="mt-4 flex flex-col gap-2">
          <div className="flex flex-row gap-2">
            <button className="flex-1 hover:bg-zinc-500 dark:bg-zinc-600 bg-zinc-400 cursor-pointer py-2 rounded-md">
              <NavLink to={`/cards/${id}`} className="text-white block text-center">
                Batafsil
              </NavLink>
            </button>
